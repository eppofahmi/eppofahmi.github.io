...
tagar %>%
  ...
  coord_flip() +
  facet_wrap(~fase) +
  ggtitle("Tagar paling sering digunakan") +
  labs(x = "Tagar", 
       y = "Frekuensi")
```
...
user_terlibat %>%
  ...
  coord_flip() +
  facet_wrap(~fase) +
  ggtitle("Username yang paling sering ada dalam twit") +
  labs(x = "Username", 
       y = "Frekuensi")
```
...
ggplot(fase1_dist, aes(x = date, y = n)) + 
  geom_line() + 
  ggtitle("Distribusi twit pada fase Emergence") +
  labs(x = NULL, 
       y = NULL)
```
...
Terdapat 14 hari di mana tagar pada fase 1 lebih sering digunakan. 13 hari diantaranya berasal secara berutan dari tanggal 09 oktober 2013 hingga 21 oktober 2013. Sementara satu lainya dari tanggal 15 November 2013. 
