...
```{r intro1, echo = FALSE, out.width = '100%', fig.cap = "RStudio Interface terdiri empat bagian utama."}
...
```{r intro5, echo = FALSE, out.width = '40%', align="center", fig.cap = "RStudio Interface terdiri empat bagian utama."}
knitr::include_graphics("images/installpackage.png")
```
...
```{r contohtable, echo=FALSE, warning=FALSE, message=FALSE}
library(DT)
library(tidyverse)
a = ggplot2::msleep %>%
  head(n = 5) %>%
...
knitr::kable(a, caption = "Contoh Isi sebuah data frame")
```
